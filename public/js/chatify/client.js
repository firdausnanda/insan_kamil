...
const getMessengerId = () => $('#message-form input[type="hidden"][name="id"]').val();
...
let app_modal = function ({
    ...
    // header
    headermodal.find(".app-modal-header").html(header);

    // body
    bodymodal.find(".app-modal-body").html(body);
